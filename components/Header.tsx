...
export default function Header({
  ...
  return (
    <div className={cn("w-full bg-slate-900 border-b border-slate-800 shadow-md", className)}>
      <div className="absolute inset-0  from-indigo-900/20 to-blue-900/10 pointer-events-none" />
